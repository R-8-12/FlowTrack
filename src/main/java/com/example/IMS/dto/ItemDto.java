...
public class ItemDto {
	...
	@Pattern(regexp = "^[A-Za-z][A-Za-z0-9 -]{2,50}$", message = "Item name must be 3-50 characters and can contain letters, numbers, spaces, and hyphens")
	...
	@Pattern(regexp = "^[A-Za-z][A-Za-z0-9 &.,-]{2,50}$", message = "Vendor name must be 3-50 characters and can contain letters, numbers, spaces, and common symbols (&.,-)")
